...
(unlocks nmap — **Slice 1 app seam + Slice 2 deploy/egress + argv hardening both landed, CLOSED**, ADR 0077), ~~Prometheus scrape + alert rules (ADR 0078, H-8c follow-up — CLOSED)~~, the MEDIUM/LOW sweep (#105, M-5, M-6, wikidata-via-`guarded_stream`, dig/nmap richer
