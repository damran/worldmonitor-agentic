...
(unlocks nmap — **Slice 1 app seam landed**, ADR 0077 §6; Slice 2 deploy infra pending), the MEDIUM/LOW sweep (#105, M-5, M-6, wikidata-via-`guarded_stream`, dig/nmap richer
